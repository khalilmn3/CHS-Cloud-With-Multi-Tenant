...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    this.columnDefs = [{
      ...
      headerName: this.$t('common.table.chargePercent'),
  ...
  methods: {
    ...
    editData: function editData() {
      ...
      _utils_request_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("".concat(this.routeApi, "/").concat(this.idData.id_log, "/edit")).then(function (response) {
    ...
    updateData: function updateData() {
      ...
      _utils_request_js__WEBPACK_IMPORTED_MODULE_0__["default"].put("".concat(this.routeApi, "/").concat(this.idData.id_log), this.vModel).then(function () {
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.$t("common.accountEDC"))
                                      ),
                                    ]),
                                  ]
                                ),
                                ...
                                _c(
                                  ...
                                  [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(_vm.errors.first("account"))
                                        ),
                                      ]
                                    ),
                                  ],
                              ...
                              [
                                _c(
                                  ...
                                  [
                                    _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.$t("common.chargePercent"))
                                      ),
                                    ]),
                                  ]
                                ),
                                        ...
                                        directives: [
                                          {
                                            ...
                                            rawName: "v-show",
                                            value:
                                              _vm.errors.has("charge percent"),
                                            expression:
                                              "errors.has('charge percent')",
                                          },
                                        ],
                                        staticClass: "error-text text-danger",
                                      },
