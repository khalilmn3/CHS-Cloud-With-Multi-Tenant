...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this6.$refs.arCityLedgerForm.showModal(idData, modeData);
    ...
    deleteData: function deleteData(dataX) {
      var _this7 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5() {
        var params, _yield$arCityLedgerRe2, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                _yield$arCityLedgerRe2 = _context5.sent;
                ...
                if (data == 0) {
                  ...
                  _utils_dialog_js__WEBPACK_IMPORTED_MODULE_9__["default"].information(_this7.$t("responseStatus.cityLedgerInvoice.".concat(data)));
                }
    ...
    // Payment
    getInvoicePayment: function getInvoicePayment(params) {
      var _this8 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                _yield$arCityLedgerRe3 = _context6.sent;
                data = _yield$arCityLedgerRe3.data;
                _this8.rowData2 = data;
    ...
    handleInsertPayment: function handleInsertPayment(params) {
      var _this9 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return _this9.getDataLookupPayment();

              case 2:
                _context7.next = 4;
                return _this9.getInvoiceDetail(params);

              case 4:
                if (!(_this9.paramsData.is_paid == '-1')) {
                  _context7.next = 7;
                  break;
                }

                _utils_dialog_js__WEBPACK_IMPORTED_MODULE_9__["default"].information(_this9.$t('responseStatus.cityLedgerInvoice.2'));
                return _context7.abrupt("return");

              case 7:
                _this9.resetPayment(_this9.paramsData);

                _this9.handleChangeCurrency();

                _this9.paymentPopUp = true;
    ...
    getInvoiceDetail: function getInvoiceDetail(params) {
      var _this10 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8() {
        var _yield$arCityLedgerRe4, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                _yield$arCityLedgerRe4 = _context8.sent;
                data = _yield$arCityLedgerRe4.data;
                _this10.paramsData = data;
    ...
    handleSavePayment: function handleSavePayment() {
      var _this11 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _this11.$validator.validateAll('information').then(function (result) {
                  if (result) {
                    _this11.insertPayment();
                  }
                });
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _this12.vPayment.currency_code = _this12.vCurrency.code;
                _context10.prev = 2;
                _context10.next = 5;
                return arCityLedgerResource.insertPayment(_this12.vPayment);

              case 5:
                _yield$arCityLedgerRe5 = _context10.sent;
                data = _yield$arCityLedgerRe5.data;

                if (data == 0) {
                  _this12.paymentPopUp = false;

                  _this12.refreshData(_this12.search);
                } else if (data > 0) {
                  _this12.$closeLoadingIndicator(_this12);

                  _utils_dialog_js__WEBPACK_IMPORTED_MODULE_9__["default"].information(_this12.$t("responseStatus.cityLedgerInvoice.".concat(data)));
                }
    ...
    getDataLookupPayment: function getDataLookupPayment() {
      var _this13 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 4:
                _yield$arCityLedgerRe6 = _context11.sent;
                data = _yield$arCityLedgerRe6.data;
                _this13.dataLookup = data;
            ...
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                return arCityLedgerResource.deletePayment({
                  number: params.number,
                  user_id: _this14.global.userInfo.code
                });

              case 4:
                _yield$arCityLedgerRe7 = _context12.sent;
                ...
                if (data == 0) {
                  ...
                  _utils_dialog_js__WEBPACK_IMPORTED_MODULE_9__["default"].information(_this14.$t("responseStatus.cityLedgerInvoice.".concat(data)));
                }
            ...
            switch (_context13.prev = _context13.next) {
              case 0:
                params = {
                  ...
                  table: _this15.global.tableName.subFolio
                };

                _this15.$loadingIndicator(_this15);
              ...
              case 5:
                ...
                _this15.dataTracking = data.modelGrid;
                _context13.next = 13;
                break;
              ...
              case 13:
                _this15.$closeLoadingIndicator(_this15);
                                    ...
                                    directives: [
                                      {
                                        ...
                                        rawName: "v-show",
                                        value:
                                          _vm.errors.has("information.date"),
                                        expression:
