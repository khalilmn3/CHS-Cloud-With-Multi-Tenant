          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                data = _ref3.data;
                this.vModel = data;
                decryptPassword = CryptoJS.AES.decrypt(data.password, this.global._CRYPTO_KEY, {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                encryptPassword = CryptoJS.AES.encrypt(this.vModel.password, this.global._CRYPTO_KEY, {
                  format: CryptoJSAesJson
                }).toString();
                encryptCPassword = CryptoJS.AES.encrypt(this.vModel.c_password, this.global._CRYPTO_KEY, {
                  format: CryptoJSAesJson
                }).toString();
    ...
    saveData: function saveData() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          ...
          _this3.vModel.user_id = _this3.global.userInfo.code;
