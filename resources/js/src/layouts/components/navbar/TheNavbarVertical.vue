    ...
    <vs-navbar class="vx-navbar navbar-custom navbar-skelton" :color="navbarColorLocal">
      ...
      <div class="the-navbar__user-meta flex items-center" v-if="user_displayName">
        <div class="text-right leading-tight hidden sm:block">
          <p class="font-semibold">{{ user_displayName | capitalizeFirst }}</p>
          <small>{{ activeUserGroupInfo | capitalize }}</small>
        </div>
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
          <div class="con-img ml-3">
            <!-- <img
              ...
              width="40"
              height="40"
              class="initial-image rounded-full shadow-md cursor-pointer block" /> -->
            <div
              width="40"
              height="40"
              class="initial-image rounded-full shadow-md cursor-pointer block">
            ...
            <ul style="min-width: 9rem">
              ...
              <vs-divider class="m-1"></vs-divider> -->
                <li
                    ...
                    <vs-icon icon-pack="feather" icon="icon icon-lock"/>
...
export default {
    ...
    methods: {
        ...
        logout() {
            ...
            this.$vs.loading({container:'#layout--main',scale:1});
        ...
        initialImg(){
            this.initial = this.activeUserInfo.charAt(0);
            // document.getElementsByClassName('initial-image').text(initial)
        }
    },
    directives: {
        'click-outside': {
